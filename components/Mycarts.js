...
const Mycarts = ({navigation,route}) => {
 ...
 return (
  <ScrollView>
   <View  style={{ backgroundColor:'#f0f2f3'}}>
    <FlatList data={data}
      renderItem={({item}) => (
       <View style={ styles.mycart_list_outer }>
          <TouchableOpacity  style={[styles.notification_list]}>
            ...
            <Text style={styles.product_detail_rating}>4.4
              ...
              <View style={styles.cart_img}>
                <Image  source={{ uri : item.pic }} style={styles.cart_img_inner} />
              </View>
        
            </View>
             </TouchableOpacity> 
  
             <View style={ styles.mycart_row }>

                <View style={ styles.mycart_btn}> 
                  <Text style={ styles.my_cart_text}> 
                    <Icon style={styles.hedericon}
                    size={15}
                    name="trash-bin-sharp"/> Remove </Text> 
                </View>
                ...
                <View style={ styles.mycart_btn}> 
                  ...
                  <Icon style={styles.hedericon}
                    size={15}
                    name="ios-archive"/>  Save for later </Text>
                </View>
            </View>
          </View>
      )}
